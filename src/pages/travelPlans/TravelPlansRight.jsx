  ...
  return (
    <>
      ...
      <div className={`d-flex flex-column gap-4 ${!isShowMore?'plan-details-right-sec-container':'plan-details-right-sec-container-h-full'}`}>
        <div className="plan-detail-header"><TbClipboardList size={17} /> Showing {23} plans <div onClick={() => setAdditional(true)} className="settin-button-plan"><VscSettings /></div></div>
