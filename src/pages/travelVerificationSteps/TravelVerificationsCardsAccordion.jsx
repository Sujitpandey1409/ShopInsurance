...
const dataTravellersNameAge = [
  { age: "20", name: "" },
  { age: "25", name: "" },
  { age: "21", name: "" },
];

export default function VehicleVerificationsCardsAccordion({
  stepsActiveState,
  setStepsDoneState,
  stepsDoneState,
  toggleCKYCDetails,
  ...
  const [travellersCountNameData, setTravelerCountNameData] = useState(
    dataTravellersNameAge
  );
    ...
    if (policyType === "Passport") {
      if (!passportNo || passportNo.trim() === "") {
        ...
        newErrors.passportNo =
          "Passport No can only contain letters and numbers";
      ...
      if (!passportFileNo || passportFileNo.trim() === "") {
        ...
        newErrors.passportFileNo =
          "Passport File No can only contain letters and numbers";
      } else if (passportFileNo.length < 5 || passportFileNo.length > 10) {
        newErrors.passportFileNo =
          "Passport File No must be 5–10 characters long";
      }
    }

    if (policyType === "Other" && !otherId) {
      newErrors.otherId =
        'Please provide the ID for the selected "Other" option';
    }
  ...
  return (
    ...
    >
                  ...
                  <Col md={6}>
                    <FormGroup tag="fieldset">
                      ...
                      <div className="d-flex gap-4">
                        {["CKYC", "PAN", "Aadhar", "Passport", "Other"].map(
                          (option) => (
                    ...
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            setCkyc(e.target.value);
                            setErrorsKyc({ ...errorsKyc, ckyc: "" });
                          }}
                          className={`custom-input form-control ${
                            sbmttActn && (!ckyc || errorsKyc.ckyc)
                              ? "blink-error"
                              : ""
                          }`}
                        />
                        {errorsKyc.ckyc && (
                          <div className="text-danger">{errorsKyc.ckyc}</div>
                        )}
                      </FormGroup>
                    </Col>
                  )}
                      ...
                      <FormGroup>
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            setErrorsKyc({ ...errorsKyc, panCard: "" });
                          }}
                          className={`custom-input form-control ${
                            sbmttActn && (!panCard || errorsKyc.panCard)
                              ? "blink-error"
                              : ""
                          }`}
                        />
                        {errorsKyc.panCard && (
                          <div className="text-danger">{errorsKyc.panCard}</div>
                        )}
                      </FormGroup>
                    </Col>
                  )}
                      ...
                      <FormGroup>
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            setErrorsKyc({ ...errorsKyc, aadharNumber: "" });
                          }}
                          className={`custom-input form-control ${
                            sbmttActn &&
                            (!aadharNumber || errorsKyc.aadharNumber)
                              ? "blink-error"
                              : ""
                          }`}
                        />
                        {errorsKyc.aadharNumber && (
                          <div className="text-danger">
                            {errorsKyc.aadharNumber}
                          </div>
                        )}
                        ...
                        <FormGroup>
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              setErrorsKyc({ ...errorsKyc, passportNo: "" });
                            }}
                            className={`custom-input form-control ${
                              sbmttActn && (!passportNo || errorsKyc.passportNo)
                                ? "blink-error"
                                : ""
                            }`}
                          />
                          {errorsKyc.passportNo && (
                            <div className="text-danger">
                              {errorsKyc.passportNo}
                            </div>
                          )}
                      ...
                      <Col md={6}>
                        <FormGroup>
                          ...
                          <Input
                            ...
                            className={`custom-input form-control ${
                              sbmttActn &&
                              (!passportFileNo || errorsKyc.passportFileNo)
                                ? "blink-error"
                                : ""
                            }`}
                          />
                          {errorsKyc.passportFileNo && (
                            <div className="text-danger">
                              {errorsKyc.passportFileNo}
                            </div>
                          )}
                      ...
                      <FormGroup>
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            setErrorsKyc({ ...errorsKyc, otherId: "" });
                          }}
                          className={`custom-input form-control ${
                            sbmttActn && (!otherId || errorsKyc.otherId)
                              ? "blink-error"
                              : ""
                          }`}
                        />
                        {errorsKyc.otherId && (
                          <div className="text-danger">{errorsKyc.otherId}</div>
                        )}
                      </FormGroup>
                    </Col>
                  )}
                    ...
                    <FormGroup>
                      ...
                      >
                        ...
                        <DatePicker
                          ...
                          maxDate={new Date()}
                          className={`form-control w-full custom-input form-control ${
                            sbmttActn && (!dateOfBirth || errorsKyc.dateOfBirth)
                              ? "blink-error"
                              : ""
                          }`}
                        />
                    ...
                    <FormGroup check>
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          setErrorsKyc({ ...errorsKyc, agreeTerms: "" });
                        }}
                      />
                      <label
                        style={{
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        className={`form-control ${
                          sbmttActn && (errorsCustomer.fullName || !FullName)
                            ? "blink-error"
                            : ""
                        }`}
                      />
                      {errorsCustomer.fullName && (
                        <div className="text-danger">
                          {errorsCustomer.fullName}
                        </div>
                      )}
                    ...
                    <FormGroup>
                      ...
                      >
                        ...
                        <DatePicker
                          ...
                          className={`form-control w-full custom-input form-control ${
                            sbmttActn &&
                            (!cDateOfBirth || errorsCustomer.dateOfBirth)
                              ? "blink-error"
                              : ""
                          }`}
                        />
                        <span
                          className="input-icon"
                          onClick={() =>
                            document.querySelector("#cdateOfBirth").focus()
                          }
                          style={{ cursor: "pointer", position: "absolute" }}
                        >
                          <CiCalendarDate size={20} />
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        className={`form-control ${
                          sbmttActn &&
                          (errorsCustomer.Nationality || !Nationality)
                            ? "blink-error"
                            : ""
                        }`}
                      >
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        className={`form-control ${
                          sbmttActn &&
                          (errorsCustomer.cPassportNo || !cPassportNo)
                            ? "blink-error"
                            : ""
                        }`}
                      />
                      {errorsCustomer.cPassportNo && (
                        <div className="text-danger">
                          {errorsCustomer.cPassportNo}
                        </div>
                      )}
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        className={`form-control ${
                          sbmttActn && (errorsCustomer.visaType || !visaType)
                            ? "blink-error"
                            : ""
                        }`}
                      >
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        className={`form-control ${
                          sbmttActn &&
                          (errorsCustomer.maritalStatus || !maritalStatus)
                            ? "blink-error"
                            : ""
                        }`}
                      />
                      {errorsCustomer.maritalStatus && (
                        <div className="text-danger">
                          {errorsCustomer.maritalStatus}
                        </div>
                      )}
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        className={`form-control ${
                          sbmttActn && (errorsCustomer.address || !cAddress)
                            ? "blink-error"
                            : ""
                        }`}
                      />
                      {errorsCustomer.cAddress && (
                        <div className="text-danger">
                          {errorsCustomer.cAddress}
                        </div>
                      )}
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        className={`form-control ${
                          sbmttActn &&
                          (errorsCustomer.occupation || !occupation)
                            ? "blink-error"
                            : ""
                        }`}
                      />
                      {errorsCustomer.occupation && (
                        <div className="text-danger">
                          {errorsCustomer.occupation}
                        </div>
                      )}
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          setErrorsCustomer({ ...errorsCustomer, email: "" });
                        }}
                        invalid={errorsCustomer.email}
                        className={`form-control ${
                          sbmttActn && (errorsCustomer.email || !email)
                            ? "blink-error"
                            : ""
                        }`}
                      />
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        className={`form-control ${
                          sbmttActn &&
                          (errorsCustomer.courseDuration || !courseDuration)
                            ? "blink-error"
                            : ""
                        }`}
                      >
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        className={`form-control ${
                          sbmttActn &&
                          (errorsCustomer.semestersCount || !semestersCount)
                            ? "blink-error"
                            : ""
                        }`}
                      >
                  ...
                  <Col md={3}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        className={`form-control ${
                          sbmttActn &&
                          (errorsCustomer.relationship || !relationship)
                            ? "blink-error"
                            : ""
                        }`}
                      >
      ...
      {/* Accordion Field for Shop Details */}
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          setErrorsNominee({ ...errorsNominee, firstName: "" });
                        }}
                        invalid={errorsNominee.firstName}
                        className={`form-control ${
                          sbmttActn && (errorsNominee.firstName || !firstName)
                            ? "blink-error"
                            : ""
                        }`}
                      />
                      {errorsNominee.firstName && (
                        <div className="text-danger">
                          {errorsNominee.firstName}
                        </div>
                      )}
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        className={`form-control ${
                          sbmttActn && (errorsNominee.middlename || !middleName)
                            ? "blink-error"
                            : ""
                        }`}
                      />
                      {errorsNominee.middleName && (
                        <div className="text-danger">
                          {errorsNominee.middleName}
                        </div>
                      )}
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          setErrorsNominee({ ...errorsNominee, lastName: "" });
                        }}
                        invalid={errorsNominee.lastName}
                        className={`form-control ${
                          sbmttActn && (errorsNominee.lastName || !lastName)
                            ? "blink-error"
                            : ""
                        }`}
                      />
                      {errorsNominee.lastName && (
                        <div className="text-danger">
                          {errorsNominee.lastName}
                        </div>
                      )}
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          setErrorsNominee({ ...errorsNominee, pinCode: "" });
                        }}
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          setErrorsNominee({ ...errorsNominee, city: "" });
                        }}
                        invalid={errorsNominee.city}
                        className={`form-control ${
                          sbmttActn && (errorsNominee.city || !city)
                            ? "blink-error"
                            : ""
                        }`}
                      />
                      {errorsNominee.city && (
                        <div className="text-danger">{errorsNominee.city}</div>
                      )}
                    </FormGroup>
                  </Col>
                </Row>
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        className={`form-control ${
                          sbmttActn && (errorsNominee.nomineeAge || !nomineeAge)
                            ? "blink-error"
                            : ""
                        }`}
                      />
                      {errorsNominee.nomineeAge && (
                        <div className="text-danger">
                          {errorsNominee.nomineeAge}
                        </div>
                      )}
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        className={`form-control ${
                          sbmttActn &&
                          (errorsNominee.relationship || !relationship)
                            ? "blink-error"
                            : ""
                        }`}
                      />
                      {errorsNominee.relationship && (
                        <div className="text-danger">
                          {errorsNominee.relationship}
                        </div>
                      )}
